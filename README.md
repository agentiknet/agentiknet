...
Founder & builder at **[Agentik](https://agentik.net)** — I design the infrastructure for autonomous AI agents and the products built on top of it.

I work across the whole stack: an open agent protocol, the design systems that theme it, and live products that put real agents to work.
...
**Building with:** Mastra · Model Context Protocol (MCP) · multi-agent orchestration · monorepo architecture

---

## 📫 Reach me

- 🌐 [agentik.net](https://agentik.net)
- ✉️ jeremy@agentik.net

<sub>Designing the protocol layer, the design layer, and the products — so agents can actually do the work.</sub>
